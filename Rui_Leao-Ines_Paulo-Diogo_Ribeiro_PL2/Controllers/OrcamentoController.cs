...
namespace Rui_Leao_Ines_Paulo_Diogo_Ribeiro_PL2.Controllers
{
    ...
    Utilizador utilizador)
        ...
        {
            string mesAno = DateTime.Now.ToString("MMMM yyyy");
            using (var db = new IShopping())
            {
                return db.Orcamentos.FirstOrDefault(o => o.MesAno == mesAno)?.ValorMax;
            }
        }
        ...
        public float? DinheiroAtual()
        {
            ...
            using (var db = new IShopping())
            {
                return db.Orcamentos.FirstOrDefault(o => o.MesAno == mesAno)?.ValorAtual;
            }
        }
    }
}
